...
class AccountScreen_admin extends StatefulWidget {
  const AccountScreen_admin({super.key});

  @override
  State<AccountScreen_admin> createState() => _AccountScreen_adminState();
}

class _AccountScreen_adminState extends State<AccountScreen_admin> {
  @override
      ...
      body: ListView(
        children: [
          Padding(
            ...
            TextButton(
              ...
              child: const Text("Update name"),
                  ...
                  Expanded(
                    // Added Expanded widget to avoid rendering issues
                    child: Column(
                      children: [
                        Text(
                          user?.displayName ?? "",
          ...
          const Account_listile(
              text: 'Diliver Addres', iconca: AppImages.mestopolejeniya),
          const Divider(
            color: AppColors.c_030303,
          ),
          const Account_listile(
              text: 'Paymet Methods', iconca: AppImages.cart_),
          const Divider(
            color: AppColors.c_030303,
          ),
          ...
          const Account_listile(
              text: 'Notifications', iconca: AppImages.notification),
          const Divider(
            color: AppColors.c_030303,
          ),
